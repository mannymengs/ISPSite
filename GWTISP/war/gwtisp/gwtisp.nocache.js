...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwtisp" because\n';
  ...
  $wnd.__gwt_activeModules['gwtisp'] = {
    'moduleName' : 'gwtisp',
    'bindings' : function() {
      return {};
    }
 ...
 * "/gwtisp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwtisp'].superdevmode = true;

  var expectedSuffix = '/gwtisp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwtisp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwtisp';
  var devModeSessionKey = '__gwtDevModeSession:gwtisp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/gwtisp/gwtisp.nocache.js';
  ...
  $wnd.__gwt_activeModules['gwtisp'].canRedirect = true;
  $wnd.__gwt_activeModules['gwtisp'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwtisp?user.agent=' + ua + '&_callback=' + callback;
